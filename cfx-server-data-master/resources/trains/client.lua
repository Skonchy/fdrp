Citizen.CreateThread(function()
    ...
    while true do
		...
		if(IsControlPressed(0,58) and IsControlPressed(0,21) and(GetGameTimer() - TrainVars.EnterExitDelay) > TrainVars.EnterExitDelayMax) then
			TrainVars.EnterExitDelay = 0
			DeleteTrains()
		...
		if(IsControlPressed(0,111) and IsControlPressed(0,21) and(GetGameTimer() - TrainVars.EnterExitDelay) > TrainVars.EnterExitDelayMax) then
			TrainVars.EnterExitDelay = 0
			DeleteTrains()
		end
    end
