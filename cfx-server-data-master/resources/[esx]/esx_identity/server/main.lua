...
function setIdentity(identifier, data, callback)
	...
	MySQL.Async.execute('INSERT INTO chars (ID, STEAMID, Username, Firstname, Lastname, DOB, Gender, d_license, cd_license, license_p, b_license, f_license) VALUES (@ID, @STEAMID, @Username, @Firstname, @Lastname, @DOB, @Gender, @d_license, @cd_license, @license_p, @b_license, @f_license)',
	{
		['@ID']		= identifier,
