...
--------------------------------------------------------------------------------------------
		...
		if (IsControlPressed(1, Config.TPMarker.keyboard1) and IsControlPressed(1, Config.TPMarker.keyboard2) and (GetGameTimer() - GUI.Time) > 150) then
...
--------------------------------------- MANETTE
		if Config.general.controllers then
			if (IsControlPressed(2, Config.TPMarker.controller1) and IsControlPressed(2, Config.TPMarker.controller2) and (GetGameTimer() - GUI.Time) > 150) then
				TriggerEvent('NB:closeAllSubMenu')
				TriggerEvent('NB:closeAllMenu')
				TriggerEvent('NB:goTpMarcker')
				GUI.Time  = GetGameTimer()
...
--------------------------------------------------------------------------------------------
		...
		if (IsControlPressed(1, Config.menuperso.keyboard) and not ESX.UI.Menu.IsOpen('default', GetCurrentResourceName(), 'menu_perso') and (GetGameTimer() - GUI.Time) > 150) then
			TriggerEvent('NB:closeAllSubMenu')
			TriggerEvent('NB:closeAllMenu')
		...
		if (IsControlPressed(1, Config.menuperso.keyboard) and ESX.UI.Menu.IsOpen('default', GetCurrentResourceName(), 'menu_perso') and (GetGameTimer() - GUI.Time) > 150) then
			TriggerEvent('NB:closeAllSubMenu')
			TriggerEvent('NB:closeAllMenu')
			GUI.Time  = GetGameTimer()
		end
...
--------------------------------------- MANETTE
		...
		if Config.general.manettes then
			if (IsControlPressed(2, Config.menuperso.controller1) and IsControlPressed(0, Config.menuperso.controller2) and not ESX.UI.Menu.IsOpen('default',  GetCurrentResourceName(), 'menu_perso') and (GetGameTimer() - GUI.Time) > 150) then
				TriggerEvent('NB:closeAllSubMenu')
				TriggerEvent('NB:closeAllMenu')
				TriggerEvent('NB:openMenuPersonnel')
				GUI.Time  = GetGameTimer()
			...
			if (IsControlPressed(2, Config.menuperso.controller1) and IsControlPressed(0, Config.menuperso.controller2) and ESX.UI.Menu.IsOpen('default',  GetCurrentResourceName(), 'menu_perso') and (GetGameTimer() - GUI.Time) > 150) then
				TriggerEvent('NB:closeAllSubMenu')
				TriggerEvent('NB:closeAllMenu')
				GUI.Time  = GetGameTimer()
			end
...
--------------------------------------------------------------------------------------------
		...
		if (IsControlPressed(1, Config.menujob.keyboard) and PlayerData.job ~= nil and PlayerData.job.name == 'police' and not ESX.UI.Menu.IsOpen('default', 'esx_policejob', 'police_actions') and (GetGameTimer() - GUI.Time) > 150) then
			TriggerEvent('NB:closeAllSubMenu')
			TriggerEvent('NB:closeAllMenu')
  	...
  	if (IsControlPressed(1, Config.menujob.keyboard) and PlayerData.job ~= nil and PlayerData.job.name == 'police' and ESX.UI.Menu.IsOpen('default', 'esx_policejob', 'police_actions') and (GetGameTimer() - GUI.Time) > 150) then
			TriggerEvent('NB:closeAllSubMenu')
			TriggerEvent('NB:closeAllMenu')
			GUI.Time = GetGameTimer()
		end
...
--------------------------------------- MANETTE
		...
		if Config.general.controllers then
			if (IsControlPressed(2, Config.menujob.controller1) and IsControlPressed(2, Config.menujob.controller2) and PlayerData.job ~= nil and PlayerData.job.name == 'police' and not ESX.UI.Menu.IsOpen('default', 'esx_policejob', 'police_actions') and (GetGameTimer() - GUI.Time) > 150) then
				TriggerEvent('NB:closeAllSubMenu')
				TriggerEvent('NB:closeAllMenu')
				TriggerEvent('NB:openMenuPolice')
				GUI.Time  = GetGameTimer()
			...
			if (IsControlPressed(2, Config.menujob.controller1) and IsControlPressed(2, Config.menujob.controller2) and PlayerData.job ~= nil and PlayerData.job.name == 'police' and ESX.UI.Menu.IsOpen('default', 'esx_policejob', 'police_actions') and (GetGameTimer() - GUI.Time) > 150) then
				TriggerEvent('NB:closeAllSubMenu')
				TriggerEvent('NB:closeAllMenu')
				GUI.Time  = GetGameTimer()
			end
...
--------------------------------------------------------------------------------------------
		...
		if (IsControlPressed(1, Config.menujob.keyboard) and PlayerData.job ~= nil and PlayerData.job.name == 'ambulance' and not ESX.UI.Menu.IsOpen('default', 'esx_ambulancejob', 'mobile_ambulance_actions') and (GetGameTimer() - GUI.Time) > 150) then
			TriggerEvent('NB:closeAllSubMenu')
			TriggerEvent('NB:closeAllMenu')
		...
		if (IsControlPressed(1, Config.menujob.keyboard) and PlayerData.job ~= nil and PlayerData.job.name == 'ambulance' and ESX.UI.Menu.IsOpen('default', 'esx_ambulancejob', 'mobile_ambulance_actions') and (GetGameTimer() - GUI.Time) > 150) then
			TriggerEvent('NB:closeAllSubMenu')
			TriggerEvent('NB:closeAllMenu')
			GUI.Time = GetGameTimer()
		end
...
--------------------------------------- MANETTE
		...
		if Config.general.controllers then
			if (IsControlPressed(2, Config.menujob.controller1) and IsControlPressed(2, Config.menujob.controller2) and PlayerData.job ~= nil and PlayerData.job.name == 'ambulance' and not ESX.UI.Menu.IsOpen('default', 'esx_ambulancejob', 'mobile_ambulance_actions') and (GetGameTimer() - GUI.Time) > 150) then
				TriggerEvent('NB:closeAllSubMenu')
				TriggerEvent('NB:closeAllMenu')
				TriggerEvent('NB:openMenuAmbulance')
				GUI.Time  = GetGameTimer()
			...
			if (IsControlPressed(2, Config.menujob.controller1) and IsControlPressed(2, Config.menujob.controller2) and PlayerData.job ~= nil and PlayerData.job.name == 'ambulance' and ESX.UI.Menu.IsOpen('default', 'esx_ambulancejob', 'mobile_ambulance_actions') and (GetGameTimer() - GUI.Time) > 150) then
				TriggerEvent('NB:closeAllSubMenu')
				TriggerEvent('NB:closeAllMenu')
				GUI.Time  = GetGameTimer()
			end
...
--------------------------------------------------------------------------------------------
-- Menu Mechanic -> esx_mechanicjob
--------------------------------------------------------------------------------------------

		if (IsControlPressed(1, Config.menujob.keyboard) and PlayerData.job ~= nil and PlayerData.job.name == 'mechanic' and not ESX.UI.Menu.IsOpen('default', 'esx_mechanicjob', 'MechanicActions') and (GetGameTimer() - GUI.Time) > 150) then
			TriggerEvent('NB:closeAllSubMenu')
			TriggerEvent('NB:closeAllMenu')
			TriggerEvent('NB:openMenuMechanic')
			GUI.Time = GetGameTimer()
		end

  	if (IsControlPressed(1, Config.menujob.keyboard) and PlayerData.job ~= nil and PlayerData.job.name == 'mechanic' and ESX.UI.Menu.IsOpen('default', 'esx_mechanicjob', 'MechanicActions') and (GetGameTimer() - GUI.Time) > 150) then
			TriggerEvent('NB:closeAllSubMenu')
			TriggerEvent('NB:closeAllMenu')
			GUI.Time = GetGameTimer()
		end
...
--------------------------------------- MANETTE
		...
		if Config.general.controllers then
			if (IsControlPressed(2, Config.menujob.controller1) and IsControlPressed(2, Config.menujob.controller2) and PlayerData.job ~= nil and PlayerData.job.name == 'mechanic' and not ESX.UI.Menu.IsOpen('default', 'esx_mechanicjob', 'MechanicActions') and (GetGameTimer() - GUI.Time) > 150) then
				TriggerEvent('NB:closeAllSubMenu')
				TriggerEvent('NB:closeAllMenu')
				TriggerEvent('NB:openMenuMechanic')
				GUI.Time  = GetGameTimer()
			...
			if (IsControlPressed(2, Config.menujob.controller1) and IsControlPressed(2, Config.menujob.controller2) and PlayerData.job ~= nil and PlayerData.job.name == 'mechanic' and ESX.UI.Menu.IsOpen('default', 'esx_mechanicjob', 'MechanicActions') and (GetGameTimer() - GUI.Time) > 150) then
				TriggerEvent('NB:closeAllSubMenu')
				TriggerEvent('NB:closeAllMenu')
				GUI.Time  = GetGameTimer()
			end
...
AddEventHandler('NB:closeAllSubMenu', function()
	...
	TriggerEvent('NB:closeMenuMechanic')
...
-- Mechanic
RegisterNetEvent('NB:closeMenuMechanic')
AddEventHandler('NB:closeMenuMechanic', function()
...
Citizen.CreateThread(function()
	while true do
		...
		(ESX.UI.Menu.IsOpen('default', 'esx_mechanicjob', 'MechanicActions')) or
		...
		if NBMenuIsOpen then
			...
			DisableControlAction(0, 12, active) -- Weapon wheel
			DisableControlAction(0, 14, active) -- Weapon wheel next
			DisableControlAction(0, 15, active) -- Weapon wheel previous
			DisableControlAction(0, 16, active) -- Next weapon selection
			DisableControlAction(0, 17, active) -- Previous weapon selection
			DisableControlAction(0, 140, active) -- Punch
			DisableControlAction(0, 80, active) -- Random camera
			DisableControlAction(0, 73, active) -- Random camera
