...
station = {
	...
	{x=436.367,y=-997.586,z=24.756,s=25},
	{x=1867.55,y=3697.572,z=32.555,s=25},
	{x=-479.15,y=6027.750,z=30.340,s=25},
	{x=-482.46,y=6024.403,z=30.340,s=25},
	{x=860.08,y=-1366.859,z=26.117,s=25},
	{x=-482.08,y=60241801,z=31.3405,s=25}  --PALETO POLICE PUMP
}
...
heli_stations = {
    ...
    {x=-475.393,y=5988.2680,z=31.3367,s=33},  -- paleto police heli landing	
}
