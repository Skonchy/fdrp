	...
	SetTimeout(4000, function()
		...
		if PlayersHarvesting[source] == true then
			...
			if GazBottleQuantity >= 5 then
				TriggerClientEvent('esx:showNotification', source, '~r~You do not have more room')		
			else   
...
AddEventHandler('esx_discojob:startHarvest', function()
	...
	TriggerClientEvent('esx:showNotification', _source, 'You collected ~b~mint~s~...')
	Harvest(source)
end)
	...
	SetTimeout(4000, function()
		...
		if PlayersHarvesting2[source] == true then
			...
			if FixToolQuantity >= 5 then
				TriggerClientEvent('esx:showNotification', source, 'You do not have more room')				
			else
...
AddEventHandler('esx_discojob:startHarvest2', function()
	...
	TriggerClientEvent('esx:showNotification', _source, 'You collected ~b~Potatoes~s~...')
	Harvest2(_source)
end)
...
AddEventHandler('esx_discojob:startHarvest3', function()
	...
	TriggerClientEvent('esx:showNotification', _source, 'You collected ~b~grapes~s~...')
	Harvest3(_source)
end)
...
AddEventHandler('esx_discojob:startHarvest4', function()
	...
	TriggerClientEvent('esx:showNotification', _source, 'You collected ~b~Ground Beef~s~...')
	Harvest4(source)
end)
...
AddEventHandler('esx_discojob:startHarvest6', function()
	...
	TriggerClientEvent('esx:showNotification', _source, 'You collected ~b~Tea Leaves~s~...')
	Harvest6(source)
end)
...
AddEventHandler('esx_discojob:startHarvest7', function()
	...
	TriggerClientEvent('esx:showNotification', _source, 'You collected ~b~Orange Slices~s~...')
	Harvest7(source)
end)
...
AddEventHandler('esx_discojob:startHarvest8', function()
	...
	TriggerClientEvent('esx:showNotification', _source, 'You collected ~b~Malted Barley~s~...')
	Harvest8(source)
end)
...
AddEventHandler('esx_discojob:startHarvest9', function()
	...
	TriggerClientEvent('esx:showNotification', _source, 'You collected ~b~Syrup~s~...')
	Harvest9(source)
end)
...
AddEventHandler('esx_discojob:startHarvest10', function()
	...
	TriggerClientEvent('esx:showNotification', _source, 'You collected ~b~Cocoa~s~...')
	Harvest10(source)
end)
...
AddEventHandler('esx_discojob:startHarvest11', function()
	...
	TriggerClientEvent('esx:showNotification', _source, 'You collected ~b~Sparkling Water~s~...')
	Harvest11(source)
end)
...
AddEventHandler('esx_discojob:startHarvest12', function()
	...
	TriggerClientEvent('esx:showNotification', _source, 'You collected ~b~Citrus~s~...')
	Harvest12(source)
end)
...
AddEventHandler('esx_discojob:startHarvest13', function()
	...
	TriggerClientEvent('esx:showNotification', _source, 'You collected ~b~Coffee Beans~s~...')
	Harvest13(source)
end)
	...
	SetTimeout(4000, function()
		...
		if PlayersCrafting[source] == true then
			...
			if GazBottleQuantity <= 0 then
				TriggerClientEvent('esx:showNotification', source, 'You do not have enough mint.')		
			else   
...
AddEventHandler('esx_discojob:startCraft', function()
	...
	TriggerClientEvent('esx:showNotification', _source, 'Preparing a ~b~Mojito~s~...')
	Craft(_source)
end)
	...
	SetTimeout(4000, function()
		...
		if PlayersCrafting2[source] == true then
			...
			if FixToolQuantity <= 0 then
				TriggerClientEvent('esx:showNotification', source, 'You do not have enough potatoes')				
			else
...
AddEventHandler('esx_discojob:startCraft2', function()
	...
	TriggerClientEvent('esx:showNotification', _source, 'Preparing ~b~Vodka~s~...')
	Craft2(_source)
end)
	...
	SetTimeout(4000, function()
		...
		if PlayersCrafting3[source] == true then
            ...
            if CaroToolQuantity <= 0 then
				TriggerClientEvent('esx:showNotification', source, 'You do not have enough grapes.')					
			else
...
AddEventHandler('esx_discojob:startCraft3', function()
	...
	TriggerClientEvent('esx:showNotification', _source, 'Preparing ~b~Champagne~s~...')
	Craft3(_source)
end)
...
local function Craft4(source)
	...
	SetTimeout(4000, function()
		...
		if PlayersCrafting4[source] == true then
            ...
            if CaroToolQuantity <= 0 then
				TriggerClientEvent('esx:showNotification', source, 'You do not have enough ground beef.')					
			else
...
AddEventHandler('esx_discojob:startCraft4', function()
	...
	TriggerClientEvent('esx:showNotification', _source, 'Preparing a ~b~Hamburger~s~...')
	Craft4(_source)
end)
...
local function Craft6(source)
	...
	SetTimeout(4000, function()
		...
		if PlayersCrafting6[source] == true then
            ...
            if CaroToolQuantity <= 0 then
				TriggerClientEvent('esx:showNotification', source, 'You do not have enough tea.')					
			else
...
AddEventHandler('esx_discojob:startCraft6', function()
	...
	TriggerClientEvent('esx:showNotification', _source, 'Preparing ~b~Ice-Tea~s~...')
	Craft6(_source)
end)
...
local function Craft7(source)
	...
	SetTimeout(4000, function()
		...
		if PlayersCrafting7[source] == true then
            ...
            if CaroToolQuantity <= 0 then
				TriggerClientEvent('esx:showNotification', source, 'You do not have enough orange slices.')					
			else
...
AddEventHandler('esx_discojob:startCraft7', function()
	...
	TriggerClientEvent('esx:showNotification', _source, 'Preparing ~b~Orange Juice~s~...')
	Craft7(_source)
end)
...
local function Craft8(source)
	...
	SetTimeout(4000, function()
		...
		if PlayersCrafting8[source] == true then
            ...
            if CaroToolQuantity <= 0 then
				TriggerClientEvent('esx:showNotification', source, 'You do not have enough malted barley')					
			else
...
AddEventHandler('esx_discojob:startCraft8', function()
	...
	TriggerClientEvent('esx:showNotification', _source, 'Preparing ~b~Whisky~s~...')
	Craft8(_source)
end)
...
local function Craft9(source)
	...
	SetTimeout(4000, function()
		...
		if PlayersCrafting9[source] == true then
            ...
            if CaroToolQuantity <= 0 then
				TriggerClientEvent('esx:showNotification', source, 'You do not have enough syrup')					
			else
...
AddEventHandler('esx_discojob:startCraft9', function()
	...
	TriggerClientEvent('esx:showNotification', _source, 'Preparing a ~b~Diablo~s~...')
	Craft9(_source)
end)
...
local function Craft10(source)
	...
	SetTimeout(4000, function()
		...
		if PlayersCrafting10[source] == true then
            ...
            if CaroToolQuantity <= 0 then
				TriggerClientEvent('esx:showNotification', source, 'You do not have enough Cocoa')					
			else
...
AddEventHandler('esx_discojob:startCraft10', function()
	...
	TriggerClientEvent('esx:showNotification', _source, 'Preparing a ~b~Hot Chocolate~s~...')
	Craft10(_source)
end)
...
local function Craft11(source)
	...
	SetTimeout(4000, function()
		...
		if PlayersCrafting11[source] == true then
            ...
            if CaroToolQuantity <= 0 then
				TriggerClientEvent('esx:showNotification', source, 'You do not have enough sparkling water')					
			else
...
AddEventHandler('esx_discojob:startCraft11', function()
	...
	TriggerClientEvent('esx:showNotification', _source, 'Preparing a ~b~Perrier~s~...')
	Craft11(_source)
end)
...
local function Craft12(source)
	...
	SetTimeout(4000, function()
		...
		if PlayersCrafting12[source] == true then
            ...
            if CaroToolQuantity <= 0 then
				TriggerClientEvent('esx:showNotification', source, 'You do not have enough citrus')					
			else
...
AddEventHandler('esx_discojob:startCraft12', function()
	...
	TriggerClientEvent('esx:showNotification', _source, 'Preparing a ~b~Schweppes~s~...')
	Craft12(_source)
end)
...
local function Craft13(source)
	...
	SetTimeout(4000, function()
		...
		if PlayersCrafting13[source] == true then
            ...
            if CaroToolQuantity <= 0 then
				TriggerClientEvent('esx:showNotification', source, 'You do not have enough coffee beans')					
			else
...
AddEventHandler('esx_discojob:startCraft13', function()
	...
	TriggerClientEvent('esx:showNotification', _source, 'Preparing a ~b~Cup of Coffee~s~...')
	Craft13(_source)
end)
...
ESX.RegisterUsableItem('mojito', function(source)
	...
	xPlayer.removeInventoryItem('mojito', 0)
...
ESX.RegisterUsableItem('vodka', function(source)
	...
	xPlayer.removeInventoryItem('vodka', 0)
...
ESX.RegisterUsableItem('champagne', function(source)
	...
	xPlayer.removeInventoryItem('champagne', 0)
...
ESX.RegisterUsableItem('hamburger', function(source)
	...
	xPlayer.removeInventoryItem('hamburger', 0)
...
ESX.RegisterUsableItem('coca', function(source)
	...
	xPlayer.removeInventoryItem('coca', 0)
...
ESX.RegisterUsableItem('icetea', function(source)
	...
	xPlayer.removeInventoryItem('icetea', 0)
...
ESX.RegisterUsableItem('orangina', function(source)
	...
	xPlayer.removeInventoryItem('orangina', 0)
...
ESX.RegisterUsableItem('wisky', function(source)
	...
	xPlayer.removeInventoryItem('wisky', 0)
...
ESX.RegisterUsableItem('diabolo', function(source)
	...
	xPlayer.removeInventoryItem('diabolo', 0)
...
ESX.RegisterUsableItem('chocolatchaud', function(source)
	...
	xPlayer.removeInventoryItem('chocolatchaud', 0)
...
ESX.RegisterUsableItem('perrier', function(source)
	...
	xPlayer.removeInventoryItem('perrier', 0)
...
ESX.RegisterUsableItem('schweppes', function(source)
	...
	xPlayer.removeInventoryItem('schweppes', 0)
...
ESX.RegisterUsableItem('cafe', function(source)
	...
	xPlayer.removeInventoryItem('cafe', 0)
