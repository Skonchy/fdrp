...
AddEventHandler('thiefInProgressPolice', function(street1, street2, veh, sex)
	if veh == "NULL" then
		TriggerClientEvent("outlawNotify", -1, "~r~Attempted LEO vehicle theft by a ~w~"..sex.." ~r~at or near ~w~"..street1.."~r~ and ~w~"..street2)
	else
		TriggerClientEvent("outlawNotify", -1, "~r~LEO vehicle stolen: ~w~"..veh.." ~r~ by a ~w~"..sex.." ~r~at or near ~w~"..street1.."~r~ and ~w~"..street2)
	end
end)
...
AddEventHandler('thiefInProgressS1Police', function(street1, veh, sex)
	if veh == "NULL" then
		TriggerClientEvent("outlawNotify", -1, "~r~Attempted LEO vehicle theft by a ~w~"..sex.." ~r~on or near ~w~"..street1)
	else
		TriggerClientEvent("outlawNotify", -1, "~r~LEO vehicle stolen: ~w~"..veh.." ~r~by a ~w~"..sex.." ~r~on or near ~w~"..street1)
	end
end)
...
AddEventHandler('thiefInProgress', function(street1, street2, veh, sex)
	if veh == "NULL" then
		TriggerClientEvent("outlawNotify", -1, "~r~Attempted vehicle theft by a ~w~"..sex.." ~r~reported near ~w~"..street1.."~r~ and ~w~"..street2)
	else
		TriggerClientEvent("outlawNotify", -1, "~r~Stolen vehicle reported: ~w~"..veh.." ~r~ by a ~w~"..sex.." ~r~near ~w~"..street1.."~r~ and ~w~"..street2)
	end
end)
...
AddEventHandler('thiefInProgressS1', function(street1, veh, sex)
	if veh == "NULL" then
		TriggerClientEvent("outlawNotify", -1, "~r~Attempted vehicle theft by a ~w~"..sex.." ~r~on ~w~"..street1)
	else
		TriggerClientEvent("outlawNotify", -1, "~r~Stolen vehicle reported: ~w~"..veh.." ~r~by a ~w~"..sex.." ~r~on ~w~"..street1)
	end
end)

RegisterServerEvent('meleeInProgress')
AddEventHandler('meleeInProgress', function(street1, street2, sex)
	TriggerClientEvent("outlawNotify", -1, "~r~A fight has been reported involving a ~w~"..sex.." ~r~near ~w~"..street1.."~r~ and ~w~"..street2)
end)

RegisterServerEvent('meleeInProgressS1')
AddEventHandler('meleeInProgressS1', function(street1, sex)
	TriggerClientEvent("outlawNotify", -1, "~r~A fight has been reported involving a ~w~"..sex.." ~r~on ~w~"..street1)
end)


RegisterServerEvent('gunshotInProgress')
AddEventHandler('gunshotInProgress', function(street1, street2, sex)
	TriggerClientEvent("outlawNotify", -1, "~r~Gunshots reported involving a ~w~"..sex.." ~r~near ~w~"..street1.."~r~ and ~w~"..street2)
end)

RegisterServerEvent('gunshotInProgressS1')
AddEventHandler('gunshotInProgressS1', function(street1, sex)
	TriggerClientEvent("outlawNotify", -1, "~r~Gunshots reported involving a ~w~"..sex.." ~r~on ~w~"..street1)
end)
