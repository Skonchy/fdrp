...
AddEventHandler('esx_drugs:hasEnteredMarker', function(zone)
	...
	if zone == 'CokeProcessing2' then
		if coke_kiloQTE >= 1 then
			CurrentAction     = zone
			CurrentActionMsg  = _U('press_cut_coke')
			CurrentActionData = {}
		end
	end
	...
	if zone == 'MethProcessing2' then
		if meth_kiloQTE >= 1 then
			CurrentAction     = zone
			CurrentActionMsg  = _U('press_cut_meth')
			CurrentActionData = {}
		end
	end
	...
	if zone == 'WeedProcessing2' then
		if weed_kiloQTE >= 1 then
			CurrentAction     = zone
			CurrentActionMsg  = _U('press_process_weed')
			CurrentActionData = {}
		end
	...
	if zone == 'OpiumProcessing2' then
		if opium_kiloQTE >= 1 then
			CurrentAction     = zone
			CurrentActionMsg  = _U('press_cut_opium')
			CurrentActionData = {}
		end
	end
...
AddEventHandler('esx_drugs:hasExitedMarker', function(zone)
	...
	TriggerServerEvent('esx_drugs:stopTransformCoke2')
	TriggerServerEvent('esx_drugs:stopSellCoke')
	TriggerServerEvent('esx_drugs:stopHarvestMeth')
	TriggerServerEvent('esx_drugs:stopTransformMeth')
	TriggerServerEvent('esx_drugs:stopTransformMeth2')
	TriggerServerEvent('esx_drugs:stopSellMeth')
	TriggerServerEvent('esx_drugs:stopHarvestWeed')
	TriggerServerEvent('esx_drugs:stopTransformWeed')
	TriggerServerEvent('esx_drugs:stopTransformWeed2')
	TriggerServerEvent('esx_drugs:stopSellWeed')
	TriggerServerEvent('esx_drugs:stopHarvestOpium')
	TriggerServerEvent('esx_drugs:stopTransformOpium')
	TriggerServerEvent('esx_drugs:stopTransformOpium2')
...
AddEventHandler('esx_drugs:ReturnInventory', function(cokeNbr, cokekNbr, cokepNbr, methNbr, methkNbr, methpNbr, weedNbr, weedkNbr, weedpNbr, opiumNbr, opiumkNbr, opiumpNbr, jobName, currentZone)
	cokeQTE	   = cokeNbr
	coke_kiloQTE = cokekNbr
	coke_poochQTE = cokepNbr
	methQTE 	  = methNbr
	meth_kiloQTE = methkNbr
	meth_poochQTE = methpNbr
	weedQTE 	  = weedNbr
	weed_kiloQTE = weedkNbr
	weed_poochQTE = weedpNbr
	opiumQTE	   = opiumNbr
	opium_kiloQTE = opiumkNbr
	...
	while true do
		...
		if CurrentAction ~= nil then
			...
			if IsControlJustReleased(0, Keys['E']) then
				...
				elseif CurrentAction == 'CokeProcessing2' then
					TriggerServerEvent('esx_drugs:startTransformCoke2')
				...
				elseif CurrentAction == 'MethProcessing2' then
					TriggerServerEvent('esx_drugs:startTransformMeth2')
				...
				elseif CurrentAction == 'WeedProcessing2' then
					TriggerServerEvent('esx_drugs:startTransformWeed2')
				...
				elseif CurrentAction == 'OpiumProcessing2' then
					TriggerServerEvent('esx_drugs:startTransformOpium2')
