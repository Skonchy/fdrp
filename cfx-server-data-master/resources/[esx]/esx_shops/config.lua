...
Config.Zones = {
    ...
    TwentyFourSeven = {
        Items = {chips,water,chocolate,sandwich,hamburger,carokit,fixkit,pills},
        Pos = {
			...
			{x = 25.7468,   y = -1345.342, z = 28.41},
            {x = 1729.216,  y = 6414.131, z = 34.037}
        }
    },

    RobsLiquor = {
        Items = {chips,water,chocolate,sandwich,hamburger,wine,beer,vodka,tequila,whisky,pills},
        Pos = {
    ...
    Bar = {
        ...
        Pos = {
            ...
            {x = 988.03,    y = -96.78,    z = 73.84}--The Lost Clubhouse
        }
    },
    ...
    DollarPills = {
        Items = {sugar},
        Pos = {
            {x = 591.244,  y = 2743.70, z = 41.00} --Harmony
        }
    },
    ...
    VegStand = {
        Items = {corn},
        Pos = {
            {x = -1044.865,  y = 5327.933, z = 43.506}
        }
    }
}
