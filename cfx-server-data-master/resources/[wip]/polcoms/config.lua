...
Config.Animations = {

	{
	    ...
	    {label = "Overweight", type = "attitude", data = {lib = "move_m@fat@a", anim = "move_m@fat@a"}},
	    ...
	    {label = "Mopey", type = "attitude", data = {lib = "move_m@sad@a", anim = "move_m@sad@a"}},
		...
		{label = "Crouched", type = "attitude", data = {lib = "move_crouch_proto", anim = "move_crouch_proto"}},
		{label = "Prone", type = "attitude", data = {lib = "move_crawl", anim = "move_crawl"}},
		}
	},
