...
mdt = {
	...
	Script_Ver = "1.4",
	-- */* SERVER NAME */*
	Server_Name = 'FD', -- (Recommend using first initials of server name, to make it look better and fit inside box)
	-- */* MAIN COLOR FOR THINGS */* 
	Server_Color = '~p~',
	-- */* WHEN LEAVING SERVER SHOULD IT CLEAR YOUR REGISTERED VEHICLES */*
	Server_Del_Veh = false, -- (Valid Options: true or false)
	...
	Server_Show_War = false, -- (Valid Options: true or false)
	...
	Server_GodMode_Feature = false, -- (Valid Options: true or false)
	-- -- -- -- -- -- --
	-- */* ADDONS */* --
	-- -- -- -- -- -- --
