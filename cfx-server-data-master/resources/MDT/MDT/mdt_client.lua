...
local veh_displaytext = GetLabelText(GetDisplayNameFromVehicleModel(GetEntityModel(vehicle)))
	...
	--
		--if IsVehiclePreviouslyOwnedByPlayer(vehicle) == true then
			TriggerServerEvent("MDT_SQL_CHECK_PLATE", vehicleplate, veh_displaytext)
		--elseif IsVehiclePreviouslyOwnedByPlayer(vehicle) == false
		--	drawNotification("~r~You can only register a vehicle owned by you")
		--end
	--
