-----[ CHANGE THIS ]-------------------------------------------
local minutesBetweenAnnouncements = 60
local prefix = "^3[FD]^0"
local suffix = "^0."
local messages = {
    'Thank you for stopping by Face Desk RP.  Please remember to keep it in character and treat each other with respect.',
	'If you have any questions, feel free to ask using /ooc or use /help'
    'Join our discord @ http://discord.facedesk.gg'
}
local ignorelist = {
    "ip:127.0.0.1",
