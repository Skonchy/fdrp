...
Citizen.CreateThread( function()
	while true do
		...
		if ( IsControlJustReleased( 0, 314 ) or IsDisabledControlJustReleased( 0, 314 ) ) and GetLastInputMethod( 0 ) and not IsPauseMenuActive() and not blockinput and ((settings["adminOnlyTrainer"] == true and adminStatus == true) or settings["adminOnlyTrainer"] == false) then -- num+
